  ...
  function loadImage(file, x, y) {
    ...
    reader.onload = (ev) => {
      ...
      img.onload = () => {
        ...
        // Compress image for AI vision (max 5MB)
        if (onImageDropped) {
          ...
          compressCtx.drawImage(img, 0, 0, cw, ch);
          const compressedBase64 = compressCanvas.toDataURL('image/jpeg', 0.7);
          onImageDropped(file.name, compressedBase64, 'image/jpeg');
        }
      };
      img.src = base64;
    };
